...
n_hidden = 100    # number of hidden units in the RNN layer
batch_size = 200
max_epochs = 10
...
y = tf.placeholder(tf.int32, [None, max_length-1, n_classes], name="TargetY")
...
final_output = tf.nn.softmax_cross_entropy_with_logits(prediction,y)
...
with tf.Session() as sess:
    #summary_writer = tf.train.SummaryWriter('some_logdir', sess.graph)
