...
def predict(model):
	...
	samples = convert_captions_to_vectors(
		["A boy is sliding towards a base while the baseman is waiting for the ball in a baseball game ."])
...
def fetch_test_captions_vectors():
	data_x, data_y = structure_and_store_embeddings(50)
