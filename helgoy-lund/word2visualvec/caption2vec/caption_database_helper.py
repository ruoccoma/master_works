...
from sqliteDatabase import db_get_caption_vectors, db_insert_caption_vector, db_get_filename_caption_tuple_from_caption_vector, \
	db_get_caption_table_size, db_all_filename_caption_vector_tuple
